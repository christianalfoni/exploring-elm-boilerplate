...
Elm.Items.Views.Title = Elm.Items.Views.Title || {};
Elm.Items.Views.Title.make = function (_elm) {
   "use strict";
   _elm.Items = _elm.Items || {};
   _elm.Items.Views = _elm.Items.Views || {};
   _elm.Items.Views.Title = _elm.Items.Views.Title || {};
   if (_elm.Items.Views.Title.values) return _elm.Items.Views.Title.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = A2($Html.h1,_U.list([$Html$Attributes.$class("Title")]),_U.list([$Html.text("Hello world!")]));
   return _elm.Items.Views.Title.values = {_op: _op,view: view};
};
Elm.Items = Elm.Items || {};
Elm.Items.Model = Elm.Items.Model || {};
Elm.Items.Model.make = function (_elm) {
   "use strict";
   _elm.Items = _elm.Items || {};
   _elm.Items.Model = _elm.Items.Model || {};
   if (_elm.Items.Model.values) return _elm.Items.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var model = {isLoading: true,list: _U.list([])};
   var Model = F2(function (a,b) {    return {isLoading: a,list: b};});
   return _elm.Items.Model.values = {_op: _op,Model: Model,model: model};
};
Elm.Model = Elm.Model || {};
Elm.Model.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Items$Model = Elm.Items.Model.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var model = {items: $Items$Model.model};
   var Model = function (a) {    return {items: a};};
   return _elm.Model.values = {_op: _op,Model: Model,model: model};
};
Elm.Tasks = Elm.Tasks || {};
Elm.Tasks.Ajax = Elm.Tasks.Ajax || {};
Elm.Tasks.Ajax.make = function (_elm) {
   "use strict";
   _elm.Tasks = _elm.Tasks || {};
   _elm.Tasks.Ajax = _elm.Tasks.Ajax || {};
   if (_elm.Tasks.Ajax.values) return _elm.Tasks.Ajax.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   return _elm.Tasks.Ajax.values = {_op: _op,get: get};
};
Elm.Items = Elm.Items || {};
Elm.Items.Actions = Elm.Items.Actions || {};
Elm.Items.Actions.make = function (_elm) {
   "use strict";
   _elm.Items = _elm.Items || {};
   _elm.Items.Actions = _elm.Items.Actions || {};
   if (_elm.Items.Actions.values) return _elm.Items.Actions.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Tasks$Ajax = Elm.Tasks.Ajax.make(_elm);
   var _op = {};
   var update = F2(function (action,model) {
      ...
      {case "Loaded": var items = model.items;
         ...
         case "Add": var items = model.items;
           var changedItems = _U.update(items,{list: A2($List.append,items.list,_U.list([_p0._0]))});
...
Elm.Items = Elm.Items || {};
Elm.Items.Views = Elm.Items.Views || {};
Elm.Items.Views.List = Elm.Items.Views.List || {};
Elm.Items.Views.List.make = function (_elm) {
   "use strict";
   _elm.Items = _elm.Items || {};
   _elm.Items.Views = _elm.Items.Views || {};
   _elm.Items.Views.List = _elm.Items.Views.List || {};
   if (_elm.Items.Views.List.values) return _elm.Items.Views.List.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Items$Actions = Elm.Items.Actions.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var item = function (item) {    return A2($Html.li,_U.list([]),_U.list([$Html.text(item)]));};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("List")]),
      _U.list([A2($Html.button,
              _U.list([A2($Html$Events.onClick,address,$Items$Actions.Add("hoho")),$Html$Attributes.disabled(model.items.isLoading)]),
              _U.list([$Html.text("add item")]))
              ,A2($Html.ul,_U.list([$Html$Attributes.$class("List")]),A2($List.map,item,model.items.list))]));
   });
   return _elm.Items.Views.List.values = {_op: _op,item: item,view: view};
};
Elm.Bingo = Elm.Bingo || {};
Elm.Bingo.make = function (_elm) {
   ...
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Items$Actions = Elm.Items.Actions.make(_elm),
   $Items$Views$List = Elm.Items.Views.List.make(_elm),
   $Items$Views$Title = Elm.Items.Views.Title.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Model = Elm.Model.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var update = F3(function (action,update,_p0) {
      var _p1 = _p0;
      var _p2 = A2(update,action,_p1._0);
      var newModel = _p2._0;
      var additionalEffects = _p2._1;
      return {ctor: "_Tuple2",_0: newModel,_1: $Effects.batch(_U.list([_p1._1,additionalEffects]))};
   });
   var updates = F3(function (updaters,action,model) {    return A3($List.foldr,update(action),{ctor: "_Tuple2",_0: model,_1: $Effects.none},updaters);});
   var view = F2(function (address,model) {
      return A2($Html.div,_U.list([$Html$Attributes.$class("App")]),_U.list([$Items$Views$Title.view,A2($Items$Views$List.view,address,model)]));
   });
   var app = $StartApp.start({init: {ctor: "_Tuple2",_0: $Model.model,_1: $Items$Actions.getItems}
                             ,view: view
                             ,update: updates(_U.list([$Items$Actions.update]))
                             ,inputs: _U.list([])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   return _elm.Bingo.values = {_op: _op,view: view,app: app,main: main,update: update,updates: updates};
};
