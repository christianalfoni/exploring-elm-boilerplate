...
Elm.Actions.Items = Elm.Actions.Items || {};
Elm.Actions.Items.make = function (_elm) {
   "use strict";
   _elm.Actions = _elm.Actions || {};
   _elm.Actions.Items = _elm.Actions.Items || {};
   if (_elm.Actions.Items.values) return _elm.Actions.Items.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      if (_p0.ctor === "Add") {
            ...
            return _U.update(model,{items: changedItems});
         } else {
            return model;
         }
   });
   ...
   var NoOp = {ctor: "NoOp"};
   return _elm.Actions.Items.values = {_op: _op,NoOp: NoOp,Add: Add,update: update};
};
Elm.Views = Elm.Views || {};
...
Elm.Views.Title.make = function (_elm) {
   ...
   if (_elm.Views.Title.values) return _elm.Views.Title.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.Views.Title.values = {_op: _op,view: view};
};
Elm.Views = Elm.Views || {};
Elm.Views.List = Elm.Views.List || {};
Elm.Views.List.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.List = _elm.Views.List || {};
   if (_elm.Views.List.values) return _elm.Views.List.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Actions$Items = Elm.Actions.Items.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.button,_U.list([A2($Html$Events.onClick,address,$Actions$Items.Add("hoho"))]),_U.list([$Html.text("add")]))
              ,A2($Html.ul,_U.list([$Html$Attributes.$class("List")]),A2($List.map,item,model.items.list))]));
   });
   return _elm.Views.List.values = {_op: _op,item: item,view: view};
};
Elm.Model = Elm.Model || {};
Elm.Model.Items = Elm.Model.Items || {};
Elm.Model.Items.make = function (_elm) {
   "use strict";
   _elm.Model = _elm.Model || {};
   _elm.Model.Items = _elm.Model.Items || {};
   if (_elm.Model.Items.values) return _elm.Model.Items.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var model = {list: _U.list(["foo","bar"])};
   return _elm.Model.Items.values = {_op: _op,model: model};
};
Elm.Bingo = Elm.Bingo || {};
Elm.Bingo.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Model$Items = Elm.Model.Items.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $StartApp$Simple = Elm.StartApp.Simple.make(_elm),
   $Views$List = Elm.Views.List.make(_elm),
   $Views$Title = Elm.Views.Title.make(_elm);
   var _op = {};
   var view = F2(function (address,model) {
      return A2($Html.div,_U.list([$Html$Attributes.$class("App")]),_U.list([$Views$Title.view,A2($Views$List.view,address,model)]));
   });
   var update = F2(function (update,data) {    return _U.update(data,{model: A2(update,data.action,data.model)});});
   var updates = F3(function (updaters,action,model) {
      return function (_) {
         return _.model;
      }(A3($List.foldr,update,{action: action,model: model},updaters));
   });
   var main = $StartApp$Simple.start({model: {items: $Model$Items.model},view: view,update: updates(_U.list([$Actions$Items.update]))});
   return _elm.Bingo.values = {_op: _op,update: update,updates: updates,view: view,main: main};
};
